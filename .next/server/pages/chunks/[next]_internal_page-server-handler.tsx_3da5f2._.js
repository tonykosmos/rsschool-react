(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["chunks/[next]_internal_page-server-handler.tsx_3da5f2._.js", {
...
function startHandler({ isDataReq , App , Document , mod , chunkGroup  }) {
    ...
    async function runOperation(renderData, Component, namespace) {
        ...
        const req = {
            url: renderData.url,
            method: 'GET',
            headers: __TURBOPACK__imported__module__$5b$next$5d2f$internal$2f$headers$2e$ts__$28$ecmascript$29$__["headersFromEntries"](renderData.rawHeaders)
        };
...
//# sourceMappingURL=[next]_internal_page-server-handler.tsx_3da5f2._.js.map